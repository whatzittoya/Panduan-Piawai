# PENGENALAN & PANDUAN PENGGUNAAN PIAWAI FISIP

> **Sistem Manajemen Akademik Terintegrasi**\
> &#xNAN;_&#x46;akultas Ilmu Sosial dan Ilmu Politik - Universitas Riau_
...
Sebagai wujud nyata dari komitmen tersebut, FISIP Universitas Riau melalui Tim Transformasi Digital mengembangkan dan meluncurkan sistem layanan digital terintegrasi yang diberi nama **PIAWAI FISIP (Pusat Integrasi Administrasi Kepegawaian)**. PIAWAI dirancang sebagai sebuah inovasi layanan berbasis web yang bertujuan untuk menyederhanakan proses administrasi kepegawaian, mempercepat alur birokrasi, serta menghadirkan transparansi dan kejelasan informasi bagi seluruh dosen dan tenaga kependidikan.
...
Untuk menjamin keamanan, validitas, dan akuntabilitas setiap layanan, akses terhadap sistem **PIAWAI dibatasi hanya bagi pengguna yang memiliki akun email institusi resmi** (dengan domain _@lecturer.unri.ac.id_ atau _@staff.unri.ac.id_). Kebijakan ini diberlakukan guna memastikan bahwa setiap pengajuan berasal dari pengguna yang sah dan terverifikasi di lingkungan FISIP Universitas Riau.
...
**1. Meningkatkan Efisiensi Proses Administrasi Kepegawaian,** PIAWAI FISIP hadir untuk memangkas waktu dan tahapan proses administrasi yang sebelumnya dilakukan secara manual dan berulang. Dengan digitalisasi proses, pengajuan layanan dapat dilakukan kapan saja dan dari mana saja, sehingga mempercepat penyelesaian permohonan/ layanan.
...
**3. Menjamin Transparansi, Akuntabilitas, dan Kecepatan Pelayanan,** setiap proses pengajuan dalam PIAWAI FISIP dilengkapi dengan fitur pelacakan status dan notifikasi otomatis, sehingga pemohon dapat memantau perkembangan permohonan secara _real-time_. Hal ini mendorong terciptanya pelayanan yang transparan dan akuntabel karena proses dapat ditelusuri oleh semua pihak yang berkepentingan.

**4. Menyediakan Dokumentasi Digital yang Terintegrasi dan Terdokumentasi Rapi,** PIAWAI FISIP mengarsipkan seluruh histori pengajuan dan dokumen pengguna secara otomatis dalam basis data yang aman dan terorganisir. Hal ini mempermudah proses audit internal, monitoring beban kerja kepegawaian, serta pelaporan administrasi jangka panjang.

**5. Meningkatkan Kenyamanan dan Aksesibilitas Layanan Bagi Dosen dan Tenaga Kependidikan,** dengan sistem berbasis web yang ramah pengguna (_user-friendly_), PIAWAI memfasilitasi pengalaman layanan yang lebih nyaman dan mudah diakses. Seluruh pengguna dapat mengakses layanan dengan perangkat laptop, komputer, atau ponsel pintar melalui jaringan internet, tanpa harus datang tatap muka.

**6. Mendukung Transformasi Budaya Kerja Menuju Tata Kelola Digital yang Adaptif dan Responsif,** PIAWAI FISIP juga diharapkan menjadi bagian dari upaya membangun budaya kerja yang adaptif terhadap perubahan teknologi.
...
![Formulir Cuti](<Panduan Piawai/formulir-cuti-utama.png>)
...
![Formulir Surat Tugas](<Panduan Piawai/formulir-surat-tugas-utama.png>)

### 3. **Kenaikan Pangkat**

Sesuai periode penilaian yang ditentukan

![Formulir Naik Pangkat](<Panduan Piawai/formulir-naik-pangkat-utama.png>)

### 4. **Kenaikan Jabatan Fungsional**

Proses otomatisasi usulan fungsional dosen

![Formulir Jabatan Fungsional](<Panduan Piawai/formulir-jabatan-fungsional-utama.png>)

### 5. **Pengajuan Pensiun**

Untuk BUP atau pensiun dini

![Formulir Pensiun](<Panduan Piawai/formulir-pensiun-utama.png>)
...
![Detail Formulir Cuti](<Panduan Piawai/formulir-cuti-lengkap.png>) ![Elemen Form Cuti](<Panduan Piawai/elemen-form-cuti.png>) ![Pemilihan Tanggal](<Panduan Piawai/pemilihan-tanggal-cuti.png>) ![Perhitungan Durasi](<Panduan Piawai/perhitungan-durasi-cuti.png>)

### **Formulir Surat Tugas - Detail Tambahan**

![Detail Surat Tugas](<Panduan Piawai/formulir-surat-tugas-lengkap.png>) ![Elemen Form Surat Tugas](<Panduan Piawai/elemen-form-surat-tugas.png>) ![Bagian Form](<Panduan Piawai/bagian-form-surat-tugas-detail.png>)

### **Formulir Naik Pangkat - Detail Tambahan**

![Detail Naik Pangkat](<Panduan Piawai/formulir-naik-pangkat-lengkap.png>) ![Elemen Form Naik Pangkat](<Panduan Piawai/elemen-form-naik-pangkat.png>)

### **Formulir Jabatan Fungsional - Detail Tambahan**

![Detail Jabatan Fungsional](<Panduan Piawai/formulir-jabatan-fungsional-lengkap.png>)

### **Formulir Pensiun - Detail Tambahan**

![Detail Pensiun](<Panduan Piawai/formulir-pensiun-lengkap.png>) ![Elemen Form Pensiun](<Panduan Piawai/elemen-form-pensiun.png>) ![Bagian Form Pensiun](<Panduan Piawai/bagian-form-pensiun.png>) ![Submit Pensiun](<Panduan Piawai/tombol-submit-pensiun.png>)
...
![Dashboard PIAWAI FISIP](<Panduan Piawai/dashboard-piawai-fisip.png>)

Dashboard PIAWAI FISIP menyediakan fitur-fitur berikut:
...
![Formulir Model C](<Panduan Piawai/profil-formulir-model-c.png>)

Halaman profil menyediakan **Formulir Model C** yang mencakup:
...
_Dokumen ini dibuat berdasarkan konten asli dari file HTML PIAWAI FISIP_\
&#xNAN;_&#x54;erakhir diperbarui: Agustus 2025_\
&#xNAN;_&#x44;okumen asli: Draft\_Pengenalan & Panduan Penggunaan PIAWAI FISIP-2025.html_
